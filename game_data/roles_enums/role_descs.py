...
class Descriptions:
	...
	thief = "Thieves, nimble, lucky, they will srike first most of the times, but have hard time to go alone".capitalize()
	...
	necromancer = "Necromancers, Manipulators of death, summon minions to fight for them. Powerful but physically frail.".capitalize()